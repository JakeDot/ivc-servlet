...
export const INITIAL_ADDRESSABLE_OBJECTS: AddressableObject[] = [
  {
    ...
    servletClass: 'cx.ivc.servlets.WhatsAppBridgeServlet',
  ...
  },
  {
    ...
    servletClass: 'cx.ivc.servlets.TelegramBotServlet',
  ...
  {
    id: 'obj-gc-connector-01',
    name: '$gc Built-in Bot (Geocaching API)',
    kind: 'social_connector',
    connectorAddress: '$gc',
    servletName: 'GeocachingApiConnectorServlet',
    servletClass: 'cx.ivc.servlets.GeocachingApiServlet',
    endpointPath: '/ivc/v1/api/geocaching',
    protocol: 'IVC-HTTPS',
    status: 'ACTIVE',
    description: 'Geocaching API connector for built-in $gc bot functionality.',
    attributes: { apiVersion: 'v1', network: 'Geocaching', type: 'bot' },
    deltaGallery: {
      id: 'gal-gc-01',
      ownerId: 'obj-gc-connector-01',
      ownerName: '$gc',
      ownerKind: 'social_connector',
      title: '∆gallery - $gc Geocaching Bot',
      description: 'Geocache logs and location data media sync.',
      updatedAt: Date.now(),
      items: [],
    },
  },
  {
    ...
    servletClass: 'cx.ivc.servlets.ChannelDispatcherServlet',
  ...
  },
  {
    ...
    servletClass: 'cx.ivc.servlets.UserDataServlet',
  ...
  },
  {
    ...
    servletClass: 'cx.ivc.servlets.NodeHealthServlet',
  ...
  },
  {
    ...
    servletClass: 'cx.ivc.servlets.AuthGatewayServlet',
  ...
  },
  {
    ...
    servletClass: 'cx.ivc.servlets.ModelServiceServlet',
