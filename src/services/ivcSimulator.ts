...
export const INITIAL_ADDRESSABLE_OBJECTS: AddressableObject[] = [
  ...
  },
  {
    ...
    servletClass: 'com.enterprise.ivc.servlets.GeocachingApiServlet',
  ...
  {
    id: 'obj-repo-ivc-servlet',
    name: 'JakeDot/ivc-servlet Repo',
    kind: 'social_connector',
    connectorAddress: 'jakedot@ivc.cx$oper+Oo',
    servletName: 'GitHubRepoConnectorServlet',
    servletClass: 'com.enterprise.ivc.servlets.GitHubRepoServlet',
    endpointPath: '/ivc/v1/repo/ivc-servlet',
    protocol: 'IVC-HTTPS',
    status: 'ACTIVE',
    description: 'Imported gh repo JakeDot/ivc-servlet.',
    attributes: { repo: 'JakeDot/ivc-servlet' },
  },
  {
